...
$staticRoutes = [
    ...
    ['path' => '/estadisticas', 'file' => '/estadisticas.php', 'changefreq' => 'daily', 'priority' => '0.9'],
    ['path' => '/predicciones', 'file' => '/predicciones.php', 'changefreq' => 'daily', 'priority' => '0.9'],
    ['path' => '/historial', 'file' => '/historial.php', 'changefreq' => 'daily', 'priority' => '0.9'],
    ['path' => '/reglas', 'file' => '/reglas.php', 'changefreq' => 'monthly', 'priority' => '0.7'],
    ['path' => '/sobre-nosotros', 'file' => '/sobre-nosotros.php', 'changefreq' => 'monthly', 'priority' => '0.5'],
    ['path' => '/contacto', 'file' => '/contacto.php', 'changefreq' => 'monthly', 'priority' => '0.5'],
    ['path' => '/politica-privacidad', 'file' => '/politica-privacidad.php', 'changefreq' => 'yearly', 'priority' => '0.3'],
    ['path' => '/terminos-condiciones', 'file' => '/terminos-condiciones.php', 'changefreq' => 'yearly', 'priority' => '0.3'],
    ['path' => '/aviso-legal', 'file' => '/aviso-legal.php', 'changefreq' => 'yearly', 'priority' => '0.3'],

    ['path' => '/estadisticas/juego/melate', 'file' => '/estadisticas.php', 'changefreq' => 'daily', 'priority' => '0.8'],
    ['path' => '/estadisticas/juego/revancha', 'file' => '/estadisticas.php', 'changefreq' => 'daily', 'priority' => '0.8'],
    ['path' => '/estadisticas/juego/revanchita', 'file' => '/estadisticas.php', 'changefreq' => 'daily', 'priority' => '0.8'],
